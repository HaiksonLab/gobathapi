...
interface Root<ConfigT = Config> {
    ...
    Business: {
        ...
        Requisites: {
            GET: NoData<ConfigT, GetBusinessResponse>;
            Legal: {
                PATCH: BodyRe<ConfigT, RequisitesLegalParams, {
                    note: string;
                }>;
            };
            Individual: {
                PATCH: BodyRe<ConfigT, RequisitesIndividualParams, {
                    note: string;
                }>;
            };
            Selfbusy: {
                PATCH: BodyRe<ConfigT, RequisitesSelfbusyParams, {
                    note: string;
                }>;
            };
            Person: {
                PATCH: BodyRe<ConfigT, RequisitesPersonParams, {
                    note: string;
                }>;
            };
            Bank: {
                PATCH: BodyRe<ConfigT, RequisitesBankParams, {
                    note: string;
                }>;
            };
            Contacts: {
                PATCH: BodyRe<ConfigT, RequisitesContactsParams, {
                    note: string;
                }>;
            };
        };
